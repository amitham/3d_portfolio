...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send("service_x5wavcn", "template_u20wsyk", 
    { 
      from_name: form.name,
      to_name: 'Amitha',
      from_email: form.email,
      to_email: "amitha4g@gmail.com",
      message: form.message
    }, "8CfehQ2L6QPCH_XVo").then(() => {
      setLoading(false);
      ...
      <motion.div variants={slideIn('left', 'tween', 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          <label className='flex flex-col'>
            ...
            className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'></input>
          </label>
          <label className='flex flex-col'>
